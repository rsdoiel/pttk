// pdtk.go is a preprocessor package for Pandoc. The driving use case
// is passing JSON or YAML documents to Pandoc and applying a Pandoc
// template. It also provides additional tooling for maintaining
...
func Apply(src []byte, options []string) ([]byte, error) {
	...
	// FIXME: if we convert the JSON to YAML then I can generator
