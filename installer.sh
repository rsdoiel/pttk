...
PACKAGE="pttk"
VERSION="v0.0.12"
GIT_USER_OR_GROUP="rsdoiel"
RELEASE="https://github.com/$GIT_USER_OR_GROUP/$PACKAGE/releases/tag/$VERSION"
...
#
DOWNLOAD_URL="https://github.com/$GIT_USER_OR_GROUP/$PACKAGE/releases/download/$VERSION/$ZIPFILE"
